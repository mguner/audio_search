...
def silence_based_conversion(path="", min_silence_len=750,
    ...
    min_silence_len: int, in milliseconds. The minimum amount of silence to cut the audio file
    ...
    pad: int, in milliseconds. After divide the audio file into the chunks we are adding silent pads for both side of
    the chunks so that the accuracy of the speech increases.

    start: int, in milliseconds. Instead of all the audio file we can start from an arbitrary location to chop the data.
